...
DAYS_NO_CONNECTIVITY_MAX = 77730  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 77726  # send an offroad prompt after 4 days with no internet
